...
export function SkillHome() {
  ...
  return (
    <>
      <Navbar />
      <section className="min-h-screen bg-slate-900  text-white px-4 md:px-12 lg:px-20 py-16">
        <h2 className="text-5xl font-display font-bold  text-teal-400 mb-14 text-center">
          🛠️ Skills
        </h2>
